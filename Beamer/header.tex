...
\addtobeamertemplate{frametitle}{}{
    \begin{textblock*}{100mm}(0.85\textwidth,-1cm)
        \includegraphics[height=1cm]{~/Documents/LaTeX-Notes/Beamer/Figures/logo/logo.png}
    \end{textblock*}}
...
\titlegraphic{\includegraphics[height=1.3cm]{~/Documents/LaTeX-Notes/Beamer/Figures/logo/logo2.png}}